                ...
                extraToolbarContent={
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className={`p-2 rounded-lg transition-all flex items-center gap-2 text-[11px] font-bold border ${showHistory ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-500/20 border-indigo-500' : 'bg-gray-850 text-gray-400 border-gray-700'
                        }`}
                    >
                    ...
                    <button
                      ...
                      className={`p-2 rounded-lg transition-all border ${showCodePreview ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-500/20 border-indigo-500' : 'bg-gray-850 text-gray-400 border-gray-700'
                        }`}
                    >
